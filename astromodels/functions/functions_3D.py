...
class HermesTemplate_3D(Function3D, metaclass=FunctionMeta):
    r"""
        description :

            Use a 3D template that has morphology and flux information.
            For Hermes-based templates generated by the custom code.
            This has been developed because GalPropTemplate_3D formatting may not be suitable to deal with Hermes template.
            This class is beased on GalPropTemplate_3D and SpatialTemplate_2D.
            Only parameter is a normalization factor.
